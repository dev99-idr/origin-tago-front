            ...
            if(data.status == "OK"){
              ...
              /*  tagLayoutList.map(function (params) {
                ...
                for (let i = 0; i < tagLayoutList.length; i++) {
                    ...
                    bodyHtml += '   <td><button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-simple-danger" data-original-title="Remove" name = "tagRemove" id="tagRemove_' + tagLayoutList[i].idx + '"><i class="la la-2x la-trash"></i></button></td>';
                    bodyHtml += "</tr>";
