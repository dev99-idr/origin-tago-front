    ...
    const getWakeUpPrd = (thingid) => {
        ...
        ajax(options, function (data) {
            ...
            for(let i = 0 ; i < data.data.tagCollectionList.length; i++) {
                ...
                //console.log("node_name : " + data.data.tagCollectionList[i].node_name);
                //console.log("variable_name : " + data.data.tagCollectionList[i].variable_name);
                //console.log("variable_value : " + data.data.tagCollectionList[i].variable_value);
                //console.log("length : " + data.data.tagCollectionList.length);
                ...
                //if(variable_name == "conn_status"){
                //    let value = data.data.tagCollectionList[i].variable_value;                    
                //    if (value == "conn") {
                //        /* connect and alive device */
                //        connectCount++;
                //        console.log("connCount : " + connectCount);
                //    }
                //    else {
                //        disconnectCount++;
                //        console.log("discconnCount : " + disconnectCount);
                //    }
            ...
            //console.log("data.data.tagCollectionList.length : " + data.data.tagCollectionList.length);
            for(let i = 0 ; i < data.data.tagCollectionList.length; i++) {
                let currentTime = new Date().getTime();
                if(parseInt((currentTime - parseInt(data.data.tagCollectionList[i].upd_time))) < ckeck_conn_prd * 2 ){
                    connectCount++;
                        ...
                        data: [
                            {
                                ...
                                name : 'Disconnect',
                                y : (disconnectCount -4)        // for exclude initail tag
                            //},{
                            //    name : 'Unassigned',
                            //    y : UnassignedCount
                            }
                ...
                ajax(options2, function (data) {
                    ...
                    for(let i = 0 ; i < data.data.tagCollectionList.length; i++) {
                        ...
                        if(variable_name == "batt_gauge"){
                            ...
                            else if(value < 60 && value >= 30){    // change battery level ->by jylee 230319
                                mediumBatteryCount++;
                            }
                            else{
                                lowBatteryCount++;
                        ...
                        data: [
                            {
                                ...
                                y : (noBatteryCount -4)             // for exclude initail tag
                            }
