    ...
    $.colorPick.prototype = {
        ...
        init : function(){
            ...
            this.element.click(function(event) {
                ...
                self.show(self.element, event.pageX - offset.left -187, event.pageY - offset.top);
        ...
        show: function(element, left, top) {
	        ...
	        jQuery.each(this.palette, function (index, item) {
				$("#colorPick").append('<div class="colorPickButton" name="colorPickButton" hexValue="' + item + '" style="background:' + item + '"></div>');
			});
