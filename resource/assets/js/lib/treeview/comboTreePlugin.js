...
;(function ( $, window, document, undefined ) {
    ...
    ComboTree.prototype.init = function () {
      ...
      this._elemWrapper.append('<div id="' + this.comboTreeId + 'DropDownContainer" style="display:block" class="comboTreeDropDownContainer"><div class="comboTreeDropDownContent"></div>');
    ...
    ComboTree.prototype.bindings = function () {
      ...
      this._elemItemsTitle.on('click', function(e){
        if(_this.options.ThingID != ""){
          if(_this.options.ThingID==this.getAttribute('data-id')){return;}
        }
        else{
          if(!(/_/).test(this.getAttribute('data-id'))){return;}
        }
        e.stopPropagation();
    ...
    ComboTree.prototype.toggleSelectionTree = function (item, direction) {
      ...
      if (direction === undefined){
        if ($(subMenu).is(':visible'))
          $(item).children('span.comboTreeParentPlus').html("<i class='fa fa-plus'>"); //$(item).children('span.comboTreeParentPlus').html("+");
        else
          $(item).children('span.comboTreeParentPlus').html("<i class='fa fa-minus'>"); //$(item).children('span.comboTreeParentPlus').html("&minus;");
